// Sushi playback E2E — drives the REAL app (real network, real Telegram session, real
...
//
// Run:
//   flutter test integration_test/sushi_playback_e2e_test.dart -d windows --dart-define-from-file=dart_defines.dev.json
//   flutter test integration_test/sushi_playback_e2e_test.dart -d <emulator-id> --dart-define-from-file=dart_defines.dev.json
//
...
void main() {
  ...
  testWidgets('Sushi playback e2e (play / seek / episodes / subtitles)', (tester) async {
