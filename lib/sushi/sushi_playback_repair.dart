...
Future<PlaybackModel?> sushiRefreshPlaybackWithForceRepair(
  SushiRead read,
  ...
  read(sushiForceRepairNextPlaybackProvider.notifier).state = true;
...
Future<bool> sushiMaybeRetryPlayAfterLoadFailure({
