...
abstract final class SushiTvUiLimits {
...
const _kTvVisualDefaultsAppliedKey = 'sushi_tv_visual_defaults_v2_applied';

/// Leanback: TV slider (max 4) + library backdrop. Forces tvSliderBanner over carousel.
void sushiApplyTvVisualDefaults(WidgetRef ref) {
