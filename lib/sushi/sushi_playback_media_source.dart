...
bool sushiMediaSourceHasPlayableUrl(MediaSourceInfo source) {
...
MediaSourceInfo? sushiResolvePlaybackMediaSource(
  ...
  if (requested != null && requested.isNotEmpty) {
    final match = sources.firstWhereOrNull(
      (s) => s.id == requested && sushiMediaSourceHasPlayableUrl(s),
    );
    if (match != null) {
      return match;
    }
  ...
  return sources.firstWhereOrNull(sushiMediaSourceHasPlayableUrl) ?? sources.first;
}
