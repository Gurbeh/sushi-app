...
import 'package:fladder/sushi/widgets/sushi_media_play_button_skeleton.dart';
...
class SushiDetailLoadingContent extends StatelessWidget {
  final ItemBaseModel item;
  final EdgeInsets padding;

  const SushiDetailLoadingContent({
    required this.item,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SushiMediaPlayButtonSkeleton(),
                const SizedBox(height: 16),
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
