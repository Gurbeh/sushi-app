...
bool sushiRouterStackHasSeriesDetail(StackRouter router, String seriesId) {
...
Future<bool> sushiMaybeNavigateEpisodeToSeries(
  ...
  if (sushiRouterStackHasSeriesDetail(context.router, seriesId)) return false;
