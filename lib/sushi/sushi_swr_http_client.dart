...
class SushiSwrHttpClient extends http.BaseClient {
  SushiSwrHttpClient({
  ...
  Future<http.StreamedResponse> send(http.BaseRequest request) async {
    ...
    final cacheKey = SushiApiDiskCache.key(
      userId: userId,
      method: request.method,
      uri: request.url,
    );

    final cached = await SushiApiDiskCache.read(cacheKey);
  ...
  static http.StreamedResponse _entryToStreamed(SushiApiDiskCacheEntry entry, http.BaseRequest request) {
  ...
  static bool _shouldCache(http.BaseRequest request) => sushiSwrShouldCacheRequest(request);
...
bool sushiSwrShouldCacheRequest(http.BaseRequest request) {
