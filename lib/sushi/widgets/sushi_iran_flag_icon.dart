...
class SushiIranFlagIcon extends StatelessWidget {
  final double size;

  const SushiIranFlagIcon({this.size = 22, super.key});

  static const assetPath = 'assets/sushi/flags/iran_splash_256.png';
