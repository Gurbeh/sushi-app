...
class SushiDpadTextField extends StatefulWidget {
  const SushiDpadTextField({
  ...
  @override
  State<SushiDpadTextField> createState() => SushiDpadTextFieldState();
}

class SushiDpadTextFieldState extends State<SushiDpadTextField> {
