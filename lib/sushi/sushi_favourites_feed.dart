...
class SushiFavoritesFeedResult {
  const SushiFavoritesFeedResult({
...
abstract final class SushiFavoritesFeed {
  static const _limitPerType = 15;

  /// One HTTP round-trip for all favorited items and people.
  static Future<SushiFavoritesFeedResult?> fetch(Ref ref) async {
    ...
    return SushiFavoritesFeedResult(
