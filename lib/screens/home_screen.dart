          ...
          switch (e) {
            case HomeTabs.dashboard:
              return DestinationModel(
                ...
                onLongPress: SushiConfig.isEnabled ? null : () => _showDashboardSwitcher(context, ref),
                onSecondaryTapDown: SushiConfig.isEnabled ? null : (_) => _showDashboardSwitcher(context, ref),
