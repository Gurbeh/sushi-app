...
import 'package:fladder/screens/watch_later/watch_later_screen.dart' as _i35;
...
class ControlLiveTvRoute extends _i36.PageRouteInfo<void> {
  const ControlLiveTvRoute({List<_i36.PageRouteInfo>? children})
...
/// generated route for
/// [_i18.LiveTvScreen]
class LiveTvRoute extends _i36.PageRouteInfo<LiveTvRouteArgs> {
  LiveTvRoute({
    String viewId = "",
    _i37.Key? key,
    List<_i36.PageRouteInfo>? children,
...
class OxplayerDeveloperModeRoute extends _i36.PageRouteInfo<void> {
  const OxplayerDeveloperModeRoute({List<_i36.PageRouteInfo>? children})
...
class OxplayerHelpRoute extends _i36.PageRouteInfo<void> {
  const OxplayerHelpRoute({List<_i36.PageRouteInfo>? children})
...
class OxplayerLoginRoute extends _i36.PageRouteInfo<void> {
  const OxplayerLoginRoute({List<_i36.PageRouteInfo>? children})
...
class OxplayerPlaybackDiagRoute extends _i36.PageRouteInfo<void> {
  const OxplayerPlaybackDiagRoute({List<_i36.PageRouteInfo>? children})
...
/// generated route for
/// [_i35.WatchLaterScreen]
class WatchLaterRoute extends _i36.PageRouteInfo<void> {
  const WatchLaterRoute({List<_i36.PageRouteInfo>? children})
      : super(WatchLaterRoute.name, initialChildren: children);

  static const String name = 'WatchLaterRoute';

  static _i36.PageInfo page = _i36.PageInfo(
    name,
    builder: (data) {
      return const _i35.WatchLaterScreen();
    },
  );
}
