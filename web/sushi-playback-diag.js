(function () {
  if (window.__sushiPlaybackDiag) return;
  ...
  const hookVideo = (v) => {
    if (!v || v.__sushiDiagHooked) return;
    v.__sushiDiagHooked = true;
  ...
  window.__sushiPlaybackDiagInstall = function () {
  ...
  window.__sushiPlaybackDiagUninstall = function () {
    if (state.observer) {
  ...
  window.__sushiPlaybackDiagFetchRange = async function (url) {
    const t0 = Date.now();
  ...
  window.__sushiPlaybackDiagProbeVideo = function (url) {
  ...
  window.__sushiPlaybackDiagSnapshotJson = function () {
  ...
  window.__sushiPlaybackDiag = { logs, push, redact };
})();
